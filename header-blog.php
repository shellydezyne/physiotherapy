...
<head>
    ...
    <!-- Title  -->
    <title>Blue - Ultimate Product Landing Page</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-2 col-xs-9">
                        ...
                        <div class="logo_area">
                            <a href="<?php bloginfo('template_directory'); ?>/blog"><img src="<?php bloginfo('template_directory'); ?>/img/core-img/logo.png" alt=""></a>
                        </div>
                    </div>

            ...
            <div class="row">
                <div class="col-sm-6 col-md-3 item">
                    <div class="single_footer_area">
                        <h4>About Us</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis voluptatibus sed dolores autem impedit, recusandae molestiae maiores.</p>
                ...
                <div class="col-sm-6 col-md-3 item">
                    <div class="single_footer_area">
                        ...
                        <div class="single_footer_contact_info">
                            <p><i class="icofont icofont-location-pin"></i> West Kazi para
                        ...
                        <div class="single_footer_contact_info">
                            <p><i class="icofont icofont-mail"></i> <a href="#">mail@blue.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Ajax Contact js -->
<script src="<?php bloginfo('template_directory'); ?>/js/ajax-contact.js"></script>

<!-- Meanmenu js -->
<script src="<?php bloginfo('template_directory'); ?>/js/meanmenu.js"></script>

<!-- Onepage Nav js -->
<script src="<?php bloginfo('template_directory'); ?>/js/jquery.nav.min.js"></script>
...
<script src="<?php bloginfo('template_directory'); ?>/js/YTPlayer.min.js"></script>
